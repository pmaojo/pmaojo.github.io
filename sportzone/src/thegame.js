...
thegame.prototype ={
	create: function() {
       ...
       this.game.touchControl.inputEnable();
		...
		this.game.fondo = this.add.audio('musicafondo');
		this.game.fondo.loop = true;
		this.game.fondo.play();
...
SnowBall.prototype.ballCollisionHandler= function(obj1,obj2){
    if (!this.crashed){
		...
		this.updateLives(vidas);
		if (vidas === 0){
			this.game.fondo.stop();
			this.game.state.start("gameOver",true,false,points);
		}
